...
public class TestObjectAdapter implements KonfigAdapter<TestObject> {

    @Override
    public TestObject deserialize(SerializationData data) {
        return new TestObject((String) data.data().get("testString"), (Integer) data.data().get("testInt"));
    }

    @Override
    public void serialize(SerializationData data, TestObject subject) {
